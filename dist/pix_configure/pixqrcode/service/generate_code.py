...
class GenerateCode:
    ...
    def generate(self, pix: Pix):
        key_count = len(pix.key)
        beginning_count = 22 + key_count
        return f"00020126{beginning_count}0014{self.merchant.globally_unique_identifier}01{key_count}{pix.key}520400005303986540" \
